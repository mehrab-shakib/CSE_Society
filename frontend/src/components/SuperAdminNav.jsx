...
import { MdOutlineKeyboardDoubleArrowLeft,MdAdminPanelSettings, MdOutlineAdminPanelSettings  } from "react-icons/md";
      ...
      <div className="flex items-center gap-[15px]">
        ...
        >
          <div className="relative">
            <MdOutlineAdminPanelSettings className="text-[1.5rem] text-gray-600" />
      ...
      >
        ...
        <ul className="space-y-4 text-gray-700">
          ...
          <li
            ...
            onClick={() => setActiveSection("all-clubs")}
          >
            <TbUsersGroup />
            All Clubs
          </li>
          ...
          <li
            ...
            onClick={() => setActiveSection("admin-control")}
          >
