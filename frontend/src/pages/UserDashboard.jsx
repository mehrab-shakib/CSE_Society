      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {activeSection === "my-clubs"
            ? clubs.map((club) => <ClubCard key={club.id} club={club} activeSection={activeSection} />)
            : availableClubs.map((club) => <ClubCard key={club.id} club={club} activeSection={activeSection} />)}
        </div>
      </div>
